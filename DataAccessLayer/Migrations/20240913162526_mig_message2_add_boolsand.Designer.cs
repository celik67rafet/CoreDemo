...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240913162526_mig_message2_add_boolsand")]
    partial class mig_message2_add_boolsand
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Message2", b =>
                {
                    ...
                    b.Property<bool>("VisibleInSandBox")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.BlogRayting", b =>
                {
                    b.HasOne("EntityLayer.Concrete.Blog", "Blog")
                        .WithOne("BlogRayting")
                        .HasForeignKey("EntityLayer.Concrete.BlogRayting", "BlogID");
